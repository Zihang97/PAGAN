    ...
    def __init__(self):
        ...
        for name, param in self.LSTM1.named_parameters():
            if 'bias' in name:
                ...
                nn.init.xavier_normal_(param)
        self.LSTM2 = nn.LSTM(257 + 256, 400, num_layers=1, batch_first=True)
        for name, param in self.LSTM1.named_parameters():
            if 'bias' in name:
                nn.init.constant_(param, 0.0)
            elif 'weight' in name:
...
voicefilter_net.load_state_dict(torch.load("/home/lps/voicefilter/voicefilter1/model_vf_all_vad_1_sigmoid//epoch_20.pth"))
