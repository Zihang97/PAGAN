...
class VoiceFilter(nn.Module):
    def __init__(self):
        ...
        self.LSTM1 = nn.LSTM(257 * 8 + 256, 400, num_layers=1, batch_first=True)
...
voicefilter_net.load_state_dict(torch.load("/home/lps/voicefilter/voicefilter1/model_vf_all_softmax/epoch_20.pth"))
...
for item in np_file_list:
    ...
    if (som_th == '20'):
        ...
        # vad = vad.to(device)
        out = voicefilter_net(mix, d_vector)
